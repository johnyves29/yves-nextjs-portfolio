...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className='list-disc pl-2'>
        <li>BS Information Systems - La Verdad Christian College</li>
      </ul>
    )
  },
  {
    ...
    content: (
      <ul className='list-disc pl-2'>
        ...
        <li>SoloLearn - HTML, Javascript, React and Redux</li>
      </ul>
    )
  }
]
    ...
    <section className='text-white' id='about'>
      <div className='md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16'>
        <Image
          ...
          height={500}
          placeholder='blur'
          blurDataURL={'/images/about-image.webp'}
        />
        <div className='mt-4 md:mt-0 text-left flex flex-col h-full'>
          ...
          <p className='text-base lg:text-lg'>
            ...
            looking to expand my knowledge and skill set. I am a team
            player, and I am excited to work with others to
